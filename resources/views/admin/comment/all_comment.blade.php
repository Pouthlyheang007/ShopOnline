      ...
      <div class="table-responsive">
        ...
        @foreach($comment as $key => $comm)
            <tr>
                ...
                <ul class="list_rep">
                 ...
                 @if($comm->comment_status==0)
                     ...
                     <br><button class="btn btn-default btn-xs btn-reply-comment"
                         data-product_id="{{$comm->comment_product_id}}" data-comment_id="{{$comm->comment_id}}">Trả lời bình luận</button>
              ...
              <td>
                 <a onclick="return confirm('Bạn có chắc là muồn xóa bình luận này không')" href="{{URL::to('/delete-comment/'.$comm->comment_id)}}"
