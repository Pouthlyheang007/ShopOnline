            ...
            <tr>
              ...
              <td>
                <a href="{{URL::to('/edit_product/'.$pro->product_id)}}" class="active styling-edit" ui-toggle-class="" >
                 ...
                 <a onclick="return confirm('Bạn có chắc là muồn xóa sản phẩm này không')" href="{{URL::to('/delete-product/'.$pro->product_id)}}" class="active styling-edit" ui-toggle-class="">
