            ...
            <tr>
              ...
              <td>
                <a href="{{URL::to('/edit_category_product/'.$cate_pro->category_id)}}" class="active styling-edit" ui-toggle-class="" >
                 ...
                 <a onclick="return confirm('Bạn có chắc là muồn xóa danh mục sản phẩm này không')" href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active styling-edit" ui-toggle-class="">
